...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SOSpage',
          path: '/sOSpage',
          builder: (context, params) => const SOSpageWidget(),
        ),
        FFRoute(
          name: 'FriendsPage',
          path: '/friendsPage',
        ...
        FFRoute(
          name: 'TextPage',
          path: '/textPage',
          builder: (context, params) => const TextPageWidget(),
        ),
        FFRoute(
          name: 'forgotPassword',
          path: '/forgotPassword',
        ...
        FFRoute(
          name: 'ObstaclePage',
          path: '/obstaclePage',
          builder: (context, params) => const ObstaclePageWidget(),
        ),
        FFRoute(
          name: 'DocumentsPage',
          path: '/documentsPage',
          builder: (context, params) => const DocumentsPageWidget(),
        ),
        FFRoute(
          name: 'LanguagePage',
          path: '/languagePage',
